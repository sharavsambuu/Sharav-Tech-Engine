...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sharavtechengine.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sharavtechengine ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/MaterialManager.o: MaterialManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MaterialManager.o MaterialManager.cpp

${OBJECTDIR}/SceneObject.o: SceneObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SceneObject.o SceneObject.cpp
