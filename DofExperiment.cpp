...
void DofExperiment::update(float deltaTime) {
    ...
    lightPosition = glm::vec3(360 * sin(animationTime), 40, 0);
}
...
void DofExperiment::render() {
    ...
    glm::mat4 modelMatrix = sponzaObject->getModelMatrix();
...
void DofExperiment::initialize() {
    ...
    // loading models
    sponzaObject = loadSceneModel("models/sponza.obj");
    vehicleObject = loadSceneModel("models/R8.obj");

    // let cook!!!
    windowWidth = GLFWApp::getSingleton()->getWindowWidth();
    windowHeight = GLFWApp::getSingleton()->getWindowHeight();
